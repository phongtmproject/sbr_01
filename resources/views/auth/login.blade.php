                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-default" href="{{ route('facebook.login') }}"><img src="https://en.facebookbrand.com/wp-content/themes/fb-branding/prj-fb-branding/assets/images/fb-logo.png" width="25px">
                                    {{ trans('app.login_facebook') }}
                                </a>
                                <br>
